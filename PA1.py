...
def hack_bank(account_list):
    ...
    if (length >= 2):
        minAcc = account_list[0]
        maxAcc = account_list[0]
        for index in range(length):
            if minAcc.balance > account_list[index].balance:
                minAcc = account_list[index]
            if maxAcc.balance < account_list[index].balance:
                maxAcc = account_list[index]
        minAcc.balance = minAcc.balance + 1337
        maxAcc.balance = maxAcc.balance - 1337
    pass
